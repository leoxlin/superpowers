...
| Kimi Code | `.kimi-plugin/plugin.json` | native skill discovery (no `sessionStart.skill`) | inline `skillInstructions` in manifest | `tests/kimi/` | marketplace or `/plugins install` GitHub URL |
